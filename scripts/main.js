// It is very complex to write a project using vanila javascript
...
document.querySelector("#check").addEventListener("click", () => {
    if (!player) {
        ...
        username.value = player.username;  // because if the username is empty the id generated by the class.
